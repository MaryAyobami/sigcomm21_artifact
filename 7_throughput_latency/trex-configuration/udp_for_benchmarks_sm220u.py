# TEMPLATE for sm220u — defaults to d6515's dual-real-port (different-IP) pattern.
# If lspci/ip-link show this node only has one usable port for the experiment,
# switch src/dst to match udp_for_benchmarks_xl170.py's same-IP convention instead.
#
